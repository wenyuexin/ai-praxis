...
当前已有材料支持把这些语义区分开，但不支持把其中一种恢复能力外推为全部恢复能力。
...
- Trace: 从顶层 backlog 中“Agentic 顶层 overview 缺口”出发，先基于已有主干文档形成早期综述；主题缺失和待补证方向继续保留在 `agentic/backlog.md` 与各子目录 backlog 中
