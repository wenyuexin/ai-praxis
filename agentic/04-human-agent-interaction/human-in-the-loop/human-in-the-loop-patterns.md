...
- Sources: OpenHands `Security & Action Confirmation` 官方文档、Microsoft Learn `GitHub Copilot Edits` 官方文档、`Handoff Debt: The Rediscovery Cost When Coding Agents Take Over Interrupted Tasks`
