...
如果你想先理解这个仓库里的 README、index、规则、能力与设计文档分别承担什么角色，可以先看 [docs/repo-map.md](./docs/repo-map.md)。

---

## 层级关系

仓库围绕现代 AI 的主要技术层次展开：从基础方法，到核心领域，再到应用系统、基础设施与跨学科视角。
...
如果说上一节展示的是仓库的组织骨架，这一节更关心这些层之间如何彼此依赖、逐步连成一条从基础方法到智能系统的技术主线。
...
> 从这里可以快速看到本仓库的整体覆盖范围与主要知识骨架：编号目录展开至子目录名；核心领域展开较深，扩展领域仅列三级目录。各领域更细结构见对应 README。
